...
给定A[]={46, 23, 8, 99, 31, 12, 85}，调用非递归的归并排序加表排序执行第1趟后，表元素的结果是：1, 0, 2, 3, 5, 4, 6

第一趟

| 开始        | 46   | 23   | 8    | 99   | 31   | 12   | 85   |
| ----------- | ---- | ---- | ---- | ---- | ---- | ---- | ---- |
| 表排序初始  | 0    | 1    | 2    | 3    | 4    | 5    | 6    |
| 第一趟 归并 | 23   | 46   | 8    | 99   | 12   | 31   | 85   |
| 表排序      | 1    | 0    | 2    | 3    | 4    | 5    | 6    |

给定A[]={23, 46, 8, 99, 31, 12, 85}，调用表排序后，表元素的结果是：

| 开始                 | 23/0 | 46/1 | 8/2  | 99/3 | 31/4 | 12/5 | 85/6 |
| -------------------- | ---- | ---- | ---- | ---- | ---- | ---- | ---- |
| 表排序(利用插入排序) | 0    | 1    | 2    | 3    | 4    | 5    | 6    |
|                      | 2    | 0    | 1    |      |      |      |      |
|                      | 2    | 0    | 1    | 3    |      |      |      |
|                      | 2    | 0    | 4    | 1    | 3    |      |      |
|                      | 2    | 5    | 0    | 4    | 1    | 3    |      |
...
![image-20200612113637002](picture/README/image-20200612113637002.png)

### 	基数排序

### 	桶排序

![image-20200612113752580](picture/README/image-20200612113752580.png)
...
![image-20200612212754690](picture/README/image-20200612212754690.png)

对由同样的n个整数构成的二叉搜索树（查找树）和最小堆，下面哪个说法是***不正确\***的:
